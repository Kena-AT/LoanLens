...
from src.config import (
    APP_NAME, PAGE_TITLE, LAYOUT, DEFAULT_THRESHOLD,
    REQUIRED_FEATURES, DROP_COLUMNS
)
...
def main():
    ...
    if df is not None and len(model_manager) > 0:
        ...
        # Threshold Tuning
        selected_idx, threshold = viz.render_threshold_tuning(
            model_manager.model_names, DEFAULT_THRESHOLD
        )
