...
class DataDriftDetector:
    ...
    def population_stability_index(self, reference: pd.Series, current: pd.Series, bins: int = 10) -> DriftReport:
    ...
    def detect_drift(self, current_data: pd.DataFrame, method: str = "ks_test") -> Dict[str, DriftReport]:
